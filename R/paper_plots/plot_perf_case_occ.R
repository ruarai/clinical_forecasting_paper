...
case_forecast_performance <- arrow::read_parquet("data/summary.parquet") %>%
...
ggsave(
  "results_paper/results_case_ward_CRPS.png",
  bg = "white",
  scale = 10 / 16,
  width = 14, height = 7
)
...
ggsave(
  "results_paper/results_case_ICU_CRPS.png",
  bg = "white",
  scale = 10 / 16,
  width = 14, height = 7
)
...
ggsave(
  "results_paper/results_case_ward_bias.png",
  bg = "white",
  scale = 10 / 16,
  width = 14, height = 7
)
